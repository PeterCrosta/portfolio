...
class AboutMe extends React.Component {
    constructor() {
        ...
        this.handleHarry = this.handleHarry.bind(this)
            ...
            <div id='about-me' className='container'>
                ...
                <div id='about-me-container' className='double-border'>
                    ...
                    <div className='about-me-text'>
                        ...
                        <span> </span>
                        <span className='harry-text' onMouseEnter={this.handleHarry} onMouseLeave={this.handleOff} onClick={this.handleHarry} >Harry</span>.
                        </p>
                        <p className='description'>
